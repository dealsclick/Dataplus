...
const mappingRevision = mapping => crypto.createHash('sha256').update(JSON.stringify(canonical(mapping || null))).digest('hex');
function walmartReview(mapping, review) {
  ...
  return {
    ...
    approvalToken: mappingRevision([mapping || null, review || null])
  };
}
...
module.exports = { projectWalmartCategories, walmartReview, mappingRevision };
