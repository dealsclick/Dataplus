...
function resolvePricePolicy(item = {}, db = {}, channel = {}) {
  ...
  // eBay prices must never undercut an imported MAP, LAP, or minimum allowed
  // price. Formula and manual prices remain valid only when they are higher.
  if (key === 'ebay') return { mode: 'protected', source: 'ebay-required' };
