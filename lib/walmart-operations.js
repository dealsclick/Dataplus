...
function inventoryAmount(product, db, settings, packSize) {
  ...
  const safety = resolveInventorySafety(product, safetyVendor(product, db.vendors || []), settings.walmartSafetyQty || 0).quantity, maximum = Number(settings.walmartMaxQuantity || 0);
