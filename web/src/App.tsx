...
function PurchaseOrderDetailPage() {
  ...
  return <div className="grid gap-5">
    ...
    <Tabs defaultValue="lines"><TabsList><TabsTrigger value="lines">Lines ({lines.length})</TabsTrigger><TabsTrigger value="orders">Linked orders ({(data.linkedOrders || []).length})</TabsTrigger><TabsTrigger value="receipts">Receipts ({receipts.length})</TabsTrigger><TabsTrigger value="history">History ({history.length})</TabsTrigger></TabsList>
