...
function StandaloneProductPage() {
  ...
  const excluded = new Set(["images", "aliases", "warehouseStock", "recentChanges", "systemVariants", "shopifyPurchaseVariants", "vendorOffers", "shadowSkus", "attributes", "productManagerFields", "original", "raw"])
  const allFields = Object.entries(product).filter(([key]) => !excluded.has(key))
