              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  {group.items.map((item) => {
                    ...
                    const operationsActive = item.id === "operations" && (view === "operations" || view === "order-detail")
...
function OperationsPage() {
  ...
  const [quoteForm, setQuoteForm] = useState({ buyer: "", buyerEmail: "", phone: "", source: "Manual", note: "", sku: "", title: "", qty: "1", price: "" })
    ...
    try {
      const result = await api<{ draft?: Record<string, unknown> }>("/api/order-drafts", {
        ...
        body: JSON.stringify({
          ...
          note: quoteForm.note.trim(), items: [{ sku: quoteForm.sku.trim(), title: quoteForm.title.trim() || quoteForm.sku.trim(), qty, price: Number(quoteForm.price || 0) }],
        }),
      })
      setQuoteOpen(false)
      setQuoteForm({ buyer: "", buyerEmail: "", phone: "", source: "Manual", note: "", sku: "", title: "", qty: "1", price: "" })
