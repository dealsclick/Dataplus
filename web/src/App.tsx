    ...
    <Dialog open={fulfillOpen} onOpenChange={setFulfillOpen}>
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-5xl">
        ...
        <div className="grid gap-4 py-2 sm:grid-cols-2">
          ...
          {!labelWorkflow && <><Field label="Carrier"><Input value={carrier} onChange={(event) => { setCarrier(event.target.value); setCarrierName(event.target.value) }} /></Field><Field label="Carrier display name"><Input value={carrierName} onChange={(event) => setCarrierName(event.target.value)} /></Field><Field label="Service"><Input value={service} onChange={(event) => setService(event.target.value)} placeholder="Ground, 2-day, freight" /></Field><Field label="Tracking number"><Input value={trackingNumber} onChange={(event) => setTrackingNumber(event.target.value)} /></Field><Field label="Tracking URL"><Input value={trackingUrl} onChange={(event) => setTrackingUrl(event.target.value)} /></>}
          <Field label="Ship date"><Input type="date" value={shipDate} onChange={(event) => setShipDate(event.target.value)} /></Field>
          {!labelWorkflow && <Field label="Shipping cost"><Input type="number" min="0" step="0.01" value={shippingCost} onChange={(event) => setShippingCost(event.target.value)} /></Field>}
