  ...
  useEffect(() => {
    ...
    const start = async () => {
      try {
        ...
        if (!Detector || !active) { toast.error("Camera barcode scanning is not supported in this browser. Use the scanner input instead."); setCameraOpen(false); return }
