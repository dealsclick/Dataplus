...
function OrderDetailWorkspace() {
  ...
  return <div className="grid gap-5">
    ...
    {String(order.source || "").toLowerCase() === "shopify" && <div className="grid gap-4 lg:grid-cols-2"><ShopifyDeliveryQuotePanel orderId={orderId} order={order} onUpdated={load} /><ShippingLabelReadinessPanel orderId={orderId} order={order} onUpdated={load} /></div>}
