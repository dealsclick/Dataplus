...
function PurchasingPage() {
  ...
  return <div className="grid gap-5">
    ...
    <Tabs value={tab} onValueChange={setTab}>
      <TabsList><TabsTrigger value="requirements">Purchase requirements ({numberLabel(requirements.length)})</TabsTrigger><TabsTrigger value="approvals">Awaiting approval ({numberLabel(approvalQueue.length)})</TabsTrigger><TabsTrigger value="pos">Purchase orders ({numberLabel(pos.length)})</TabsTrigger><TabsTrigger value="risks">Exceptions & risk ({numberLabel(risks.length)})</TabsTrigger></TabsList>
