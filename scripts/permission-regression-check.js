...
includes(app, "userAdminView", "User manager must separate Users and Roles views.");
includes(app, "Manage roles", "User profile must link to the dedicated roles page.");
includes(app, "Create role", "Dedicated roles page must support creating a reusable role.");
includes(app, "openBlankTemplateDialog", "Template manager must support creating a blank reusable template.");
includes(app, "Roles", "Template manager must be presented as a dedicated roles page.");
