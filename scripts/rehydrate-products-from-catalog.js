...
function normalizeCatalogProduct(record) {
  ...
  return {
    ...
    category: textValue(record.category || record.product_type) || require('../lib/datadump-category').mappedTaxonomy(record).path,
    ...
    unspsc: textValue(record.unspsc) || require('../lib/datadump-category').mappedTaxonomy(record).unspsc,
